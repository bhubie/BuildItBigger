...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetJoke extends MyApiRequest<com.example.bhuber.myapplication.backend.myApi.model.MyBean> {
     ...
     */
    protected GetJoke() {
      super(MyApi.this, "GET", REST_PATH, null, com.example.bhuber.myapplication.backend.myApi.model.MyBean.class);
    }
  ...
  public class SayHi extends MyApiRequest<com.example.bhuber.myapplication.backend.myApi.model.MyBean> {
     ...
     */
    protected SayHi() {
      super(MyApi.this, "POST", REST_PATH, null, com.example.bhuber.myapplication.backend.myApi.model.MyBean.class);
    }
